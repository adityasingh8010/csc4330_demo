...
3. Source the virtual environment ```[pipenv shell]``` or skip step 3 aand 4 and install django, django rest framework and corsheader with or without a virtual enviroment setup
